...
Se compara el error tipo I y potencia las medidas de centralidad:

- Media.
- Media Modificada.
- Media Intercuartilica.
- Media de Tukey (c=6).
- Mediana.

**Opcional**

Se pueden utilizar distintos hiperparámetros:

- Media recortada (10%, 20%, 30%, 40%). 
- Media de Tukey( c=2, 3, 4, 5, 6).
...
- Lepage. 
- Cucconi. 
- Modelos Lineales Generalizados (usando distribución gamma y prueba de razón de verosimilitud).
